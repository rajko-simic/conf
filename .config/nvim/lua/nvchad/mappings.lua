...
map("n", "<leader>fp", "<cmd>Telescope projects<CR>", { desc = "telescope project" })
...
map("n", "<leader>br", function() require("dap").toggle_breakpoint() end, { desc = "Toggle Breakpoint" })
...
map("n", "<leader>ds", function() require("dapui").float_element("scopes") end, { desc = "Show Scopes" })
map("n", "<leader>df", function() require("dapui").float_element("stacks") end, { desc = "Show Stack Frames" })
map("n", "<leader>dv", function() require("dapui").float_element("breakpoints") end, { desc = "Show Breakpoints" })
map("n", "<leader>dt", function() require("dapui").float_element("threads") end, { desc = "Show Threads" })
map("n", "<leader>dc", function() require("dapui").float_element("console") end, { desc = "Show Console" })
