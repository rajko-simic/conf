...
dap.listeners.after.event_initialized["dap_view"] = function() dapview.open() end
dap.listeners.before.event_terminated["dap_view"] = function() dapview.close() end
dap.listeners.before.event_exited["dap_view"] = function() dapview.close() end
